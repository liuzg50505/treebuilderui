...
public class InstanceBuilder {
    ...
    public InstanceBuilder(DefinitionManager definitionManager) {
    ...
    public Instance buildWidgetCode(Element widgetroot) {
        ...
        if(widgetDef instanceof TemplateDefinition) {
            ...
            for(ConstructorDefinition.ConstructorParam templateParam: definition.parameters){
        ...
        }else if(widgetDef instanceof ConstructorDefinition) {
