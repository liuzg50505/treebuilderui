...
public class ConstructorInstanceControl extends AnchorPane {
    ...
    public ConstructorInstanceControl(ConstructorInstance instance, int offsetX) {
        ...
        else instanceLabel = new Label(instance.getTypeDefinition().getTypeName());
        ...
        dragitem = null;
        if(instance!=null) {
            for (ConstructorInstance decorator: instance.getDecorators()) {
                DecoratorLabel decoratorLabel = new DecoratorLabel(decorator.getTypeDefinition().getTypeName());
                if(instance.getDecorators().indexOf(decorator)==0) {
